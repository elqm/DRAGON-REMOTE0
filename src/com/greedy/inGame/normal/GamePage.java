...
public class GamePage extends JFrame{
	...
	private JLabel glaunLb = new JLabel();

	private Font font = new Font("궁서체", Font.BOLD, 50);

	private Image fireArrow = new ImageIcon("images/firearrow.png").getImage().getScaledInstance(60, 60, 0);
	private Image glaun = new ImageIcon("images/glaunCha.png").getImage().getScaledInstance(122, 118, 0);
	...
	private int weaponX = (int)(Math.random()*1130) * (WIDTH - fireArrow.getWidth(null));
	private int weaponY = fireArrow.getHeight(null);
    private static int life = 10;
    private static int gold = 0;
    private JLabel lifeNumLb;
	...
	public GamePage() {
		...
		lifeNumLb = new JLabel("" + life);
		lifeNumLb.setBounds(50, 20, 100, 100);
	...
	private void lifeCheckCollision() {
		Rectangle characterRect = new Rectangle(xpos, ypos, glaun.getWidth(null), glaun.getHeight(null));
		Rectangle lifeRect = new Rectangle(weaponX, weaponY, fireArrow.getWidth(null), fireArrow.getHeight(null));
		if (characterRect.intersects(lifeRect)) {
			weaponY = fireArrow.getHeight(null);
			life--;
			lifeNumLb.setText("" + life);
			if (life == 0) {
				//            	frame.dispose();
				//            	new GameOver();
			}
